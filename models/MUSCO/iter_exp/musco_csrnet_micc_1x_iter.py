...
class CSRNet(nn.Module):
    def __init__(self, load_weights=True):
        ...
        self.frontend_feat = [[(3,3), (3,24), (24,64)], [(64,36), (36,33), (33,64)],
        'M', [(64,39), (39,56), (56,128)], [(128,60), (60,59), (59,128)],
        'M', [(128,72), (72,108), (108,256)], [(256,114), (114,111), (111,256)], [(256,108), (108,104), (104,256)],
        'M', [(256,136), (136,203), (203,512)], [(512,214), (214,205), (205,512)], [(512,201), (201,196), (196,512)]]
