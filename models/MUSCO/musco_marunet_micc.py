...
class MARNet(nn.Module):
    def __init__(self, load_model='', downsample=1, bn=False, NL='relu', objective='dmp', sp=False, se=False, block='', save_feature=False):
        ...
        self.front1 = make_layers(['M', [(64,8), (8,9), (9,128)], [(128,8), (8,8), (8,128)]], in_channels=64, batch_norm=bn, NL=self.NL)
        self.front2 = make_layers(['M', [(128,8), (8,9), (9,256)], [(256,12), (12,8), (8,256)], 256], in_channels=128, batch_norm=bn, NL=self.NL)
        self.front3 = make_layers(['M', [(256,26), (26,8), (8,512)], [(512,22), (22,15), (15,512)], [(512,9), (9,9), (9,512)]], in_channels=256, batch_norm=bn, NL=self.NL)
        self.front4 = make_layers(['M', [(512,8), (8,8), (8,512)], [(512,8), (8,10), (10,512)], [(512,10), (10,8), (8,512)]], in_channels=512, batch_norm=bn, NL=self.NL)
        
        self.brg = make_layers([512], in_channels=512, dilation=True, batch_norm=bn, NL=self.NL, se=se)
        
        self.back4 = make_layers([[(1024,13), (13,12), (12,512)]], in_channels=1024, dilation=True, batch_norm=bn, NL=self.NL, se=se, padding=2)
        self.back3 = make_layers([[(1024,14), (14,13), (13,256)],], in_channels=1024, dilation=True, batch_norm=bn, NL=self.NL, se=se, padding=2)
        self.back2 = make_layers([[(512,8), (8,9), (9,128)]], in_channels=512, dilation=True, batch_norm=bn, NL=self.NL, se=se, padding=2)
